...
with_node \
  ...
  --target "/Users/ayanshsingh/Downloads/Nexolink/ios/Pods/Target Support Files/Pods-NexoLink/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-asset" "expo-av" "expo-blur" "expo-constants" "expo-file-system" "expo-font" "expo-keep-awake" "expo-linear-gradient" "expo-speech"
