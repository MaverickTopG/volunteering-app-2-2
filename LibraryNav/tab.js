...
import LAIStory from '../Library/LAIStory.js';
import LFeed from '../Library/LFeed.js';
      ...
      <Tab.Navigator
        screenOptions={({ route }) => ({
          tabBarIcon: ({ focused, color, size }) => {
            let iconName;
            if (route.name == 'Library Services') {
        ...
        <Tab.Screen name="Library Services" component={LFeed} />
        <Tab.Screen name="Ordix" component={LAIStory} />
