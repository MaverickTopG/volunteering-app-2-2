...
// export default function DynamicScroll({ style }) {
...
//       <View style={[{ flex: 1, alignItems: 'center', justifyContent: 'center', marginTop: 20, backgroundColor: 'transparent' }, style]}>
//         <FlatList
//           ref={ref}
//           initialScrollIndex={index}
//           style={{ flexGrow: 0, backgroundColor: 'transparent', marginTop: 150 }} // Adjust this marginTop to move the white portion up or down
//           data={data}
